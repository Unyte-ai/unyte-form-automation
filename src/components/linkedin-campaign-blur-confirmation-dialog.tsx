...
interface LinkedInCampaignBlurConfirmationDialogProps {
  isOpen: boolean
...
export function LinkedInCampaignBlurConfirmationDialog({
  isOpen,
  fieldType,
  originalValue,
  newValue,
  ...
  onConfirm,
  onCancel
}: LinkedInCampaignBlurConfirmationDialogProps) {
